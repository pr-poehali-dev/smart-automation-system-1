...
const plans: Plan[] = [
  {
    ...
    price: 9,
    features: [
      { label: "AI-фото", count: "50" },
      { label: "Инфографика", count: "25" },
      { label: "Try-on", count: "16" },
      { label: "AI-видео", count: "10" },
    ],
  ...
  },
  {
    ...
    highlight: true,
    features: [
      { label: "AI-фото", count: "250" },
      { label: "Инфографика", count: "125" },
      { label: "Try-on", count: "83" },
      { label: "AI-видео", count: "50" },
    ],
  ...
  },
  {
    ...
    badge: "Лучшая цена",
    features: [
      { label: "AI-фото", count: "800" },
      { label: "Инфографика", count: "400" },
      { label: "Try-on", count: "266" },
      { label: "AI-видео", count: "160" },
    ],
