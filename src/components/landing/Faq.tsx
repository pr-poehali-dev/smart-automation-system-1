...
const faqs = [
  {
    ...
    answer:
      "Пиастра — внутренняя валюта сервиса. 1 Пиастра = 1 единица сгенерированного контента (фото, инфографика, примерка или видео). При регистрации вы получаете 50 Пиастр бесплатно. Докупить можно в личном кабинете в любой момент.",
  },
  {
    id: 2,
